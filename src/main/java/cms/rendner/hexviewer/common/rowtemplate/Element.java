...
public final class Element
{
     ...
     */
    @NotNull
    private final cms.rendner.hexviewer.common.geom.Dimension dimension;
     ...
     */
    public Element(@NotNull final cms.rendner.hexviewer.common.geom.Dimension dimension, @NotNull final Position position)
    {
        super();
