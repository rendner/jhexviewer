...
public final class HitInfo
{
    ...
    /**
     * Checks if the hit was inside of the bounding box of the element.
     *
    ...
    /**
     * Checks if the hit was outside of the bounding box of the element.
     *
    ...
    /**
     * Checks if the hit was outside and after the bounding box of the element.
     *
    ...
    /**
     * Checks if the hit was outside and before the bounding box of the element.
     *
