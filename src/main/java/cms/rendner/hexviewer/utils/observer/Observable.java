...
public class Observable<T> implements IObservable<T>
{
    ...
    protected void setChangedAndNotifyObservers(final T arg)
    {
        setChanged();
        notifyObservers(arg);
    }
     ...
     * words, this method is equivalent to: <code>notifyObservers(null)</code>
     *
     * @see Observable#clearChanged()
     * @see Observable#hasChanged()
     * @see IObserver#update(IObservable, java.lang.Object)
     */
    ...
    public void notifyObservers(T arg)
    {
        ...
        {
            ((IObserver<T>) arrLocal[i]).update(this, arg);
        }
    }
